...
public class CatnapWrappingView implements View, WrappingView<CatnapView>
{
    ...
    public com.catnap.core.context.HttpStatus httpStatus(HttpServletRequest request)
    {
        ...
        if(attr != null)
        {
            ...
            return com.catnap.core.context.HttpStatus.valueOf(value);
        }

        return com.catnap.core.context.HttpStatus.OK;
    }
